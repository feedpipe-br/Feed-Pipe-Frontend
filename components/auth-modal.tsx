            ...
            <ModalContent>
                <form>
                    <ModalHeader className="flex flex-col gap-1">
                        ...
                        {["login", "register"].includes(activeTab) && <p className="text-center text-muted-foreground text-sm font-normal mt-2">
                            {activeTab === "login"
                    ...
                    <ModalBody>
                        {activeTab === "email-sent" ? (
                            <div className="flex flex-col items-center text-center space-y-4">
                                ...
                                <p className="font-medium text-card-foreground bg-muted px-4 py-2 rounded-lg">
                                    {email}
                                </p>
                                <p className="text-sm text-muted-foreground">
                                    Haz clic en el enlace del correo para verificar tu cuenta y comenzar a usar
                                    NutriFit.
                                </p>
                            </div>
                        ): (
                    ...
                    {["login", "register"].includes(activeTab) && <ModalFooter>
                        <Button
